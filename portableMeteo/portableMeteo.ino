...
int H_IN = 8798;
int H_IN_MASS[90] = 
{50, 50, 51, 52, 55, 53, 54, 55, 56, 57,
59, 62, 63, 64, 67, 69, 71, 74, 79, 85, 
86, 87, 88, 89, 93, 93, 94, 93, 94, 93, 
95, 95, 95, 90, 92, 90, 87, 85, 83, 81,
77, 70, 68, 63, 62, 61, 60, 59, 58, 57,
59, 62, 63, 64, 67, 69, 71, 74, 79, 85, 
86, 87, 88, 89, 93, 93, 94, 93, 94, 93, 
95, 95, 95, 90, 92, 90, 87, 85, 83, 81,
50, 50, 51, 52, 55, 53, 54, 55, 56, 57};
...
void graph() {
  ...
  // построение правого графика
  for (int i = 21; i < 109; i++) {
    tft.drawPixel(i, 109 * pow(i, 2) / pow(108, 2), ST7735_RED);
  }

  // построение левого графика
  for (int i = 21; i < 109; i++) {
    tft.drawPixel(i, 87 * pow(i-21, 2) / pow(87, 2) + 3, 0xff6600);
  }
}

  void screen1() {
    // вывод температуры воздуха
    temp2tft(T_IN, 2, 117, 2, ST7735_RED, 0);
    ...
    temp2tft(Teff, 2, 133, 2, ST7735_GREEN, 0);
